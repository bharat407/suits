    ...
    const services = [
        {
          ...
          imageUrl: 'https://akam.cdn.jdmagicbox.com/images/website/packersandmovers.png', // Replace with actual image URL
        },
        {
        ...
        {
          title: 'Estate Agents',
          imageUrl: '	https://akam.cdn.jdmagicbox.com/images/website/estate_agent.png', // Replace with actual image URL
        },
      ];
