...
const SidebarContact = () => {
  return (
    <div className='min-w-[28%] lg:max-w-[30%] my-2 py-2 flex gap-2 border px-3 border-gray-300 rounded-lg flex-col'>
      ...
      <div>
        ...
        <p className='text-lg'>No 16, 14th Main, Dwaraka Nagar,<br /> Nagarbhavi, Bangalore - 560072</p>
      <div className='flex justify-between my-2 text-blue-500'>
          <div className='text-blue flex gap-2 items-center cursor-pointer'>
            <span className='text-xl'><FaDirections /></span>
      ...
      <SubSection icon={<MdOutlineTextsms />} content={"Get Info via SMS/Email"}/>
